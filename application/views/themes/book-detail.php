...
<head>
    ...
    <!-- custom demo style -->
    <link rel="stylesheet" type="text/css" href="<?php echo template_url('hero_files/bookblock'); ?>/demo4.css" />
...
<script type="text/javascript" src="<?php echo template_url('js'); ?>/color-thief.js"></script>
<script>
    $(window).ready(function(){
        var colorThief = new ColorThief();
        var myImage = document.getElementById("myImage");
        var i = colorThief.getColor(myImage);

        $(".bookDetail").css("background-color","rgb("+ i + ")");
    });
</script>
</body>
</html>