...
<head>
    ...
    <link href="<?php echo base_url(); ?>assets/themes/default/hero_files/store_section/default.css" rel="stylesheet">
    <link href="<?php echo base_url(); ?>assets/themes/default/hero_files/store_section/component.css" rel="stylesheet">
    <link href="<?php echo base_url(); ?>assets/themes/default/hero_files/store_section/shopping-cart.css" rel="stylesheet">
...
<footer>
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-4">
                <div class="row">
                    <p class="col-12 text-justify" style="color:#333;">
...
<script async src="<?php echo template_url('js'); ?>/store/cbpViewModeSwitch.js"></script>
<script async src="<?php echo template_url('js'); ?>/store/modernizr.custom.js"></script>

<script>
    if( !window.jQuery ) document.write('<script src="<?php echo template_url('js'); ?>/store/jquery-3.0.0.min.js"><\/script>');
</script>
<script async src="<?php echo template_url('js'); ?>/store/shopping-cart.js"></script>
<script type="text/javascript">
    $(document).on('click change', function(){
        if($("div.cd-cart-container").hasClass("cart-open") == true){
            $(".cd-cart footer").css("position", "absolute");
            $(".cd-cart header").css("position", "absolute");
        }else{
            $(".cd-cart footer").css("position", "relative");
            $(".cd-cart header").css("position", "relative");
        }
    })
</script>
</body>
